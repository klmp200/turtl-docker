...
deps: dist/ccl-1.11-linuxx86.tar.gz dist/quicklisp.lisp dist/cl-hash-util.zip dist/turtl-api.zip dist/s6-overlay-amd64.tar.gz dist/confd-0.12.0-linux-amd64
